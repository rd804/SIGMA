...
sic_score_iad , tpr_score_iad , fpr_score_iad = SIC_cut(x_test[:,-1], predict_iad)
...
plt.legend()
if args.wandb:
    wandb.log({'sic_rejection': wandb.Image(figure)})
plt.savefig(f'{save_path}sic_rejection.png')
